...
var MapController = function (_BaseController) {
    ...
    function MapController() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = MapController.__proto__ || Object.getPrototypeOf(MapController)).call.apply(_ref, [this].concat(args))), _this), _this.whitelist = ['name', 'description', 'geo'], _this._populate = function () {
            ...
            var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(req, res, next) {
                var _req$query, latitude, longitude, distance, map;

                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _req$query = req.query, latitude = _req$query.latitude, longitude = _req$query.longitude;
                                distance = 10000 / 6371;
                                _context2.prev = 2;
                                _context2.next = 5;
